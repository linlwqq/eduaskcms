...
class User extends App
{
    ...
    public function before_insert()
    {
        ...
        if (isset($this->data['password']) && $this->data['password'] === '') unset($this->data['password']);
        if (isset($this->data['password'])) $this->data['password'] = Auth::password($this->data['password']);
        return $rslt;
    }
